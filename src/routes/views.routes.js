...
router.get('/products/create', isAuthenticated, ViewsManager.create)
router.get('/products/:name', isAuthenticated, ViewsManager.productOne)
...
router.get('/users', isAdmin, ViewsManager.users)
